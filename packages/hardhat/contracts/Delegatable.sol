...
// BEGIN EIP712 AUTOGENERATED BODY. See scripts/typesToCode.js
  ...
  function GET_EIP712DOMAIN_PACKETHASH (EIP712Domain memory _input) public returns (bytes32) {
    console.log("EIP712Domain typehash: ");
    ...
    console.log("Encoded our EIP712Domain: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_INVOCATION_PACKETHASH (Invocation memory _input) public returns (bytes32) {
    ...
    console.log("Encoded our Invocation: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_SIGNEDDELEGATION_ARRAY_PACKETHASH (SignedDelegation[] memory _input) public returns (bytes32) {
    ...
    console.log("Encoded our SignedDelegation[]: ");
    console.logBytes(encoded);
    bytes32 hash = keccak256(encoded);
    return hash;
  }

  function GET_INVOCATIONS_PACKETHASH (Invocations memory _input) public returns (bytes32) {
    ...
    console.log("Encoded our Invocations: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_INVOCATION_ARRAY_PACKETHASH (Invocation[] memory _input) public returns (bytes32) {
    bytes memory encoded;
    for (uint i = 0; i < _input.length; i++) {
      encoded = bytes.concat(
        encoded,
  ...
  function GET_SIGNEDINVOCATION_PACKETHASH (SignedInvocation memory _input) public returns (bytes32) {
    console.log("SignedInvocation typehash: ");
    console.logBytes32(SIGNEDINVOCATION_TYPEHASH);
    bytes memory encoded = abi.encode(
      SIGNEDINVOCATION_TYPEHASH,
      GET_INVOCATIONS_PACKETHASH(_input.invocations),
      keccak256(_input.signature)
    );
    console.log("Encoded our SignedInvocation: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_TRANSACTION_PACKETHASH (Transaction memory _input) public returns (bytes32) {
    console.log("Transaction typehash: ");
    console.logBytes32(TRANSACTION_TYPEHASH);
    bytes memory encoded = abi.encode(
    ...
    console.log("Encoded our Transaction: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_REPLAYPROTECTION_PACKETHASH (ReplayProtection memory _input) public returns (bytes32) {
    console.log("ReplayProtection typehash: ");
    console.logBytes32(REPLAYPROTECTION_TYPEHASH);
    bytes memory encoded = abi.encode(
      REPLAYPROTECTION_TYPEHASH,
      _input.nonce,
      _input.queue
    );
    console.log("Encoded our ReplayProtection: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_DELEGATION_PACKETHASH (Delegation memory _input) public returns (bytes32) {
    ...
    console.log("Encoded our Delegation: ");
    console.logBytes(encoded);
    return keccak256(encoded);
  }

  function GET_CAVEAT_ARRAY_PACKETHASH (Caveat[] memory _input) public returns (bytes32) {
    bytes memory encoded;
    for (uint i = 0; i < _input.length; i++) {
      encoded = bytes.concat(
        encoded,
    ...
    console.log("Encoded our Caveat[]: ");
    console.logBytes(encoded);
    bytes32 hash = keccak256(encoded);
    return hash;
  }

  function GET_CAVEAT_PACKETHASH (Caveat memory _input) public returns (bytes32) {
    console.log("Caveat typehash: ");
    console.logBytes32(CAVEAT_TYPEHASH);
    bytes memory encoded = abi.encode(
      CAVEAT_TYPEHASH,
      _input.enforcer,
  ...
  function GET_SIGNEDDELEGATION_PACKETHASH (SignedDelegation memory _input) public returns (bytes32) {
    console.log("SignedDelegation typehash: ");
    console.logBytes32(SIGNEDDELEGATION_TYPEHASH);
    bytes memory encoded = abi.encode(
